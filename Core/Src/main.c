...
/* USER CODE BEGIN PV */
extern MOTOR_Structure M1;

uint32_t IC_Buffer[IC_BUFFER_SIZE];

int MotorSetRPM = 0;
GPIO_PinState MotorControlEnable = GPIO_PIN_SET;

float PWM_Duty_Cycle = 0;
float RPM = 0;
float c;

uint8_t DMACurrentPointer = 0;
uint8_t DMAPreviousPointer = 0;
/* USER CODE END PV */
